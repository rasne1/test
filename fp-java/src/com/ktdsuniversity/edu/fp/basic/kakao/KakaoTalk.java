...
public class KakaoTalk {
	...
	public static void main(String[] args) {
		...
		fl.add(new Friend("이아무개", "1995-02-28"));
...
//				&& birthdate.isAfter(LocalDate.now().minusDays(8)));
		...
		fl.printSpecialFriends2(friend -> {Period period = Period.between(friend.getBirthdate(), LocalDate.now());
								return friend.getName().startsWith("이") && period.getYears() >= 20&& period.getMonths() >= 0 && period.getDays()>=0;
		});
