...
import com.ktdsuniversity.edu.fp.basic.stream.advenced.utils.ArrayUtil;
import com.ktdsuniversity.edu.fp.basic.stream.advenced.utils.StringUtil;
...
public class City {
	...
	public static List<City> loadCityDate(){
	...
	public City(String cityLineString ) {
		...
		this.latitude = ArrayUtil.getValue(values, 5);
