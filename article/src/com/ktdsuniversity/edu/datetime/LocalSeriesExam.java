...
public class LocalSeriesExam {
	...
	public static void main(String[] args) {
		...
		//태어난 일이 무슨 요일인가 ? 
		LocalDate birthdate3 = LocalDate.of(1991, 11, 05);
		...
		LocalDate birthdate = LocalDate.parse("1991-11-05");
		...
		LocalDate birthdate2 = LocalDate.parse("1991년 11월 05일", DateTimeFormatter.ofPattern("yyyy년 MM월 dd일"));
